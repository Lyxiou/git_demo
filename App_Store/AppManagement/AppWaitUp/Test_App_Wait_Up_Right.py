...
class TestAppManagement(unittest.TestCase):
    def setUp(self):
        ...
        sleep(1)
        sreach_window = self.driver.current_window_handle 
        self.driver.find_element_by_link_text("待上架").click()
        sleep(1)        
    ...
    def check_up_app_page(self):
        ...
        #addpageurl = 'http://10.110.1.55:8082/admin/apkinfo.html?id=0000-d8be7028-fa49-4add-a2b5-0d0f21430c88&status=2'
        if (self.driver.current_url.endswith('status=2')):
            rst = True
        else:
            rst = False
        return rst
    ...
    def test_check_add_app_page(self):
        result = self.check_up_app_page()
        self.assertTrue(result)
    
    def check_up_app(self):
        ...
        sleep(1)
        sreach_window= self.driver.current_window_handle 
        after_up_url = 'http://10.110.1.55:8082/admin/apkapprovelist.html'
    ...
    def test_up_app(self):
        result = self.check_up_app()
        self.assertTrue(result)
